...
//   const { timeline } = useCandidateDetail()
...
//                 <User size={30} /> {candidate.name} <StageBadge stage={candidate.stage} size={4} px={4} py={2}/>
//               </h1>
...
export default function CandidateDetailsPage() {
  ...
  const { timeline, loading } = useCandidateDetail();
