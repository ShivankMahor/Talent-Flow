...
export default function CandidateBoardCard({ candidate, openEditModal }) {
  const badgeStyle = stageBadge[candidate.stage] || "bg-gray-50 text-gray-500 border";

  return (
    <Card className="candidate-card select-none flex justify-between items-center hover:shadow-md transition animate-slideIn border rounded-md p-3 bg-white">
      <div>
        {/* Candidate name + id */}
